...
local Class = {cls=915220}
Class.id = Class.cls * 100 + 1
rawset(_G, 'ALD/fake/skill/casting/神像/关山月', Class)
...
function Class.Create(...)
    ...
    flag.Hurt = function(self)
        ...
        FightActions.mWindAtt.Formula(player, target, {}, self.context, {0.3 * FA5a, FA5b, 1 ,0})
        -- FloatTarget()
        target:Status(EPropStatus['Floating']):Reset(1800)
    end
    player:AddTone('Wind')
